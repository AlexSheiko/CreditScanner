...
import com.creditscanner.android.ui.camera.CameraSource;
import com.creditscanner.android.ui.camera.CameraSourcePreview;
...
public final class OcrCaptureActivity extends AppCompatActivity {
    ...
    public boolean onPrepareOptionsMenu(Menu menu) {
        int operator = PreferenceManager.getDefaultSharedPreferences(this).getInt("operator", 0);
        MenuItem settingsItem = menu.findItem(R.id.action_settings);
        settingsItem.setVisible(operator != 0);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            startActivityForResult(new Intent(this, OperatorInputActivity.class), 1);
            return true;
        }
        return false;
    }
